...
def search_for_updates():
    ...
    r = requests.get("https://github.com/Bear124/adminpanel4625/releases/latest")
    ...
    if THIS_VERSION not in result_string:
        ...
        soup = BeautifulSoup(requests.get("https://github.com/Bear124/adminpanel4625/releases").text, 'html.parser')
        ...
        if choice.lower() == 'y' or choice.lower() == 'yes':
            ...
            if os.path.basename(sys.argv[0]).endswith("exe"):
                ...
                new_version_source = requests.get("https://github.com/Bear124/adminpanel4625/archive/refs/heads/master.zip")
